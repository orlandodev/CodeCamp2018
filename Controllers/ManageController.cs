    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                IsYubikeyOTPEnabled = user.IsYubikeyOTPEnabled
            };
        ...
        public async Task<ActionResult> DisableGoogleAuthenticator()
        {
            ...
            if (user != null)
            {
                ...
                user.TwoFactorEnabled = !user.IsYubikeyOTPEnabled;
        ...
        public async Task<ActionResult> DisableYubikeyOTP()
        {
            var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());

            if(user != null)
            {
                user.IsYubikeyOTPEnabled = false;
                user.TwoFactorEnabled = !user.IsGoogleAuthenticatorEnabled;
            }
        ...
        [HttpGet]
        public async Task<ActionResult> EnableYubikeyOTP(GoogleAuthenticatorViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = UserManager.FindById(User.Identity.GetUserId());

                user.IsYubikeyOTPEnabled = true;
                user.TwoFactorEnabled = true;
